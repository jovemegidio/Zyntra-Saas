...
/**
 * GET /parametros - Retorna parâmetros do MRP
 */
...
/**
 * PUT /parametros - Atualiza parâmetros do MRP
 */
router.put('/parametros', async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: 'Erro ao atualizar parâmetros' });
    }
});

/**
 * POST /parametros-item - Cadastra parâmetros MRP de um item
 */
router.post('/parametros-item', [
    ...
    try {
        ...
        res.json({
            success: true,
            message: 'Parâmetros do item cadastrados',
            parametros
        });
    } catch (error) {
        console.error('Erro ao cadastrar parâmetros:', error);
        res.status(500).json({ success: false, message: 'Erro ao cadastrar parâmetros' });
    }
});
