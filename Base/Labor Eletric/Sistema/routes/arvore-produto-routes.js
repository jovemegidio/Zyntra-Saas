...
module.exports = function createArvoreProdutoRoutes({ pool, authenticateToken, authorizeArea }) {
    ...
    router.get('/produtos', async (req, res) => {
        try {
            ...
            // AUDIT-FIX S10.5: Explicit whitelist for ORDER BY
            const ORDER_MAP = { preco: 'cc.preco_sugerido DESC', margem: 'cc.margem_liquida_perc DESC' };
            sql += ` ORDER BY ${ORDER_MAP[order] || 'cc.codigo ASC'}`;
