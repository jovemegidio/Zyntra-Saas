/**
 * User Greeting - Script compartilhado para saudação padronizada
 * Aluforce ERP System
 * 
...
(function() {
    ...
    const CONFIG = {
        ...
        avatarColors: [
            '#3b82f6', '#ef4444', '#225cfa', '#f59e0b', '#8b5cf6',
            '#ec4899', '#06b6d4', '#225cfa', '#f97316', '#6366f1'
        ]
    };
    ...
    function init() {
        ...
        console.log('[UserGreeting] Sistema de saudação inicializado');
    }
