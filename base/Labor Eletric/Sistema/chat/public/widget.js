/**
 * LABOR ELETRIC CHAT WIDGET — JavaScript
...
(function () {
  ...
  function renderMessage(msg) {
    ...
    if (isSystem) {
      ...
      div.innerHTML = `<div class="afw-msg-bubble">
        ${!isSent ? `<div class="afw-msg-sender"><img src="BobAI.png" alt="BOB"> ${isBot ? 'BOB' : msg.senderName}</div>` : ''}
  ...
  function toggleTheme() {
    const widget = $('labor-eletric-widget');
