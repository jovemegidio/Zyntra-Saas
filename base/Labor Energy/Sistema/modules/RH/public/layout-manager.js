...
(function() {
    ...
    function setupContentSections() {
        // Garante que apenas uma seçáo esteja ativa inicialmente
    ...
    // Funçáo para atualizar informações do usuário no header
