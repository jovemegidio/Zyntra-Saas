...
function isLoggedIn() {
    // Com httpOnly cookies, não temos acesso ao token no JS
    // Verificamos se há dados do usuário (setados no login)
...
window.debugDashboardData = function() {
    ...
    console.log('UserData presente:', !!sessionStorage.getItem('userData'));
