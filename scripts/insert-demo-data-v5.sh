...
-- ============ CLIENTES (nome NOT NULL, empresa_id NOT NULL) ============
...
-- ============ PEDIDOS (empresa_id NOT NULL, valor NOT NULL) ============
...
-- ============ ORDENS PRODUCAO (mais registros) ============
